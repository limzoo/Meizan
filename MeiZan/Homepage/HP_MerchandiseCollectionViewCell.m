//
//  HP_MerchandiseCollectionViewCell.m
//  MeiZan
//
//  Created by 林宇 on 2018/2/5.
//  Copyright © 2018年 rhjt. All rights reserved.
//

#import "HP_MerchandiseCollectionViewCell.h"
@interface HP_MerchandiseCollectionViewCell()
...
@end
@implementation HP_MerchandiseCollectionViewCell
- (void)createSubview{
...
- (void)setModel:(MerchandiseModel *)model{
    ...
    _buyNum.text = [NSString stringWithFormat:@" %ld人付款",model.BUY_COUNT.integerValue];
}
@end
