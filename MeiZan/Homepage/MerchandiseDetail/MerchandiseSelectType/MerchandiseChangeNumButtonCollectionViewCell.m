//
//  MerchandiseChangeNumButtonCollectionViewCell.m
//  MeiZan
//
...
@interface MerchandiseChangeNumButtonCollectionViewCell()<UITextFieldDelegate>
@property (nonatomic, strong) UITextField *numTextField;
@end
@implementation MerchandiseChangeNumButtonCollectionViewCell
- (void)createSubview{
    ...
    self.numTextField.textAlignment = NSTextAlignmentCenter;
     [self.numTextField addTarget:self action:@selector(inputTextFieldValueChange:) forControlEvents:UIControlEventEditingChanged];
...
- (void)setInitialNum:(NSInteger)initialNum{
    _initialNum = initialNum;
    self.numTextField.text = [NSString stringWithFormat:@"%ld",initialNum];
}
@end
