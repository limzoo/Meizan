 ...
 */
typedef void (^CFResponseSuccess)(NSURLSessionDataTask * task,id responseObject);
 ...
 *  @param error 报错信息
 */
typedef void (^CFResponseFail)(NSURLSessionDataTask * task, NSError * error);
 ...
 *  @param progress 进度
 */
typedef void (^CFProgress)(NSProgress *progress);
@interface MZAFNetwork : NSObject
/**
 *  普通get方法请求网络数据
 *
 *  @param url     请求网址路径
...
+(void)GET:(NSString *)url
    params:(NSDictionary *)params success:(CFResponseSuccess)success
...
+(void)GET:(NSString *)url baseURL:(NSString *)baseUrl
    params:(NSDictionary *)params success:(CFResponseSuccess)success fail:(CFResponseFail)fail;
