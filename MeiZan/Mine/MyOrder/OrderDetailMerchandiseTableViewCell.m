//
//  OrderDetailMerchandiseTableViewCell.m
//  MeiZan
//
...
@interface OrderDetailMerchandiseTableViewCell()
...
@end
@implementation OrderDetailMerchandiseTableViewCell
- (void)createSubview{
    ...
    self.num = [UILabel initWithCustomFontOfSize:[UIFont fontWithName:@"PingFangSC-Regular" size:12] color:COLOR_RGB16(0x999999) text:nil];
